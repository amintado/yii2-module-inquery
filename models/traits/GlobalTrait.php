...
namespace amintado\inquery\models\traits;
...
trait GlobalTrait
{
    ...
    public function getAuthorPanel()
    {
        ...
        $created_at = !empty($this->created_at) ? (new AmintadoFunctions())->convertdate($this->created_at) : null;
        $updated_at = !empty($this->updated_at) ? (new AmintadoFunctions())->convertdate($this->updated_at) : null;
        return '
